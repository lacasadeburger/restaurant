...
<button onClick={scrollToOrder} style={{ backgroundColor: '#ff4757', color: '#fff', padding: '14px 30px', borderRadius: '50px', border: '2px solid #000', fontWeight: '950', cursor: 'pointer', boxShadow: '0 4px 0px #b33939' }}>
  🛒 {totalPrice}€
      ...
      <div style={{ backgroundColor: '#0a0a0a', padding: '35px', borderRadius: '15px', border: '1px solid #222', textAlign: 'justify' }}>
        {/* Correction structurelle ici : utilisation de div pour le texte multilingue */}
        <div style={{ color: '#888', fontSize: '0.8rem', lineHeight: '1.8', margin: 0 }}>
          <strong>🇪🇸 ESPAÑOL:</strong> <strong>La Casa de Burger</strong> – El <strong>mejor restaurante de hamburguesas gourmet en Torrevieja</strong>... [TEXTE ESPAGNOL COMPLET]
          <br /><br />
          <strong>🇬🇧 ENGLISH:</strong> <strong>Best gourmet burgers in Torrevieja</strong> center... [TEXTE ANGLAIS COMPLET]
          <br /><br />
          <strong>🇳🇴 NORSK:</strong> <strong>Beste gourmetburger i Torrevieja</strong>... [TEXTE NORVÉGIEN COMPLET]
          <br /><br />
          <strong>🇵🇱 POLSKI:</strong> <strong>Najlepsze burgery gourmet w Torrevieja</strong>... [TEXTE POLONAIS COMPLET]
          <br /><br />
          <strong>🇲🇦 ARABIC (العربية):</strong> <strong>أفضل مطعم برجر غوارميه في توريفايجا</strong>... [TEXTE ARABE COMPLET]
          <br /><br />
          <strong>🇺🇦 UKRAINIAN:</strong> <strong>Найкращі гурме-бургери в Торрев'єсі</strong>... [TEXTE UKRAINIEN COMPLET]
          <br /><br />
          <strong>🇫🇷 FRANÇAIS:</strong> <strong>Meilleur Burger Gourmet Torrevieja</strong>... [TEXTE FRANÇAIS COMPLET]
          <br /><br />
          <strong>🇷🇺 RUSSIAN:</strong> <strong>Лучшие гурме-бургеры в Торревьехе</strong>... [TEXTE RUSSE COMPLET]
          <br /><br />
          <strong>🇸🇪 SVENSKA:</strong> <strong>Bästa gourmetburgare i Torrevieja</strong>... [TEXTE SUÉDOIS COMPLET]
          <br /><br />
          <strong>🇩🇪 DEUTSCH:</strong> <strong>Beste Gourmet-Burger in Torrevieja</strong>. <strong>Signature-Burger</strong>, hausgemachte Rezepte mit <strong>Premium-Rindfleisch</strong>.
          <br /><br />
          <strong>🇳🇱 NEDERLANDS:</strong> <strong>Beste gourmet burgers in Torrevieja</strong>. <strong>Signature burgers</strong>, <strong>premium rundvlees</strong>.
