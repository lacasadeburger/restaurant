  ...
  return (
    ...
    <style>{`
      ...
      h2, .SectionTitle, section h2, section h3 {
        ...
        margin: 40px auto 20px; color: #BF953F; font-weight: 900; text-transform: uppercase;
      }

      .grid-cards {
        display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr));
        gap: 30px; padding: 20px; width: 100%; max-width: 1300px; margin: 0 auto; justify-content: center;
      }

      .card-menu {
        display: flex; flex-direction: column; height: 100%; background: #111;
        border-radius: 12px; overflow: hidden; border: 1px solid rgba(191, 149, 63, 0.1); position: relative;
      }

      /* 2. LOGO ET NAVIGATION */
      .logo-container-wrapper {
        position: absolute; top: 150px; left: 35px; z-index: 101;
      ...
      .promo-container {
        ...
        border-radius: 20px; overflow: hidden; border: 2px solid #BF953F;
        background: #000; height: 336px; cursor: pointer;
        display: flex; flex-direction: column; justify-content: flex-end; align-items: center;
      }

      .promo-img {
        position: absolute; top: 0; left: 0; width: 100% !important; height: 100% !important;
        object-fit: cover; opacity: 0.7; transition: 0.4s ease; z-index: 1;
      }

      /* 4. IMAGES DES PRODUITS (LA RÉPARATION FINALE) */
      .card-menu-image-container {
        width: 100% !important;
        height: 230px !important; /* On force la hauteur pour les boissons/desserts */
        min-height: 230px !important;
        background: #222; /* Gris foncé pour voir le bloc si l'image rate */
        position: relative;
      ...
      .card-menu-image-container img {
        ...
        object-fit: cover !important; /* Crucial pour ne pas déformer les verres */
        opacity: 1 !important;
      ...
      /* 5. TEXTES ET TITRES */
      .card-title {
        text-align: center; width: 100%; margin: 15px 0 10px; font-size: 1.4rem;
        text-transform: uppercase; font-weight: 900;
        background: linear-gradient(135deg, #BF953F 0%, #FCF6BA 45%, #B38728 55%, #FBF5B7 100%);
        -webkit-background-clip: text; -webkit-text-fill-color: transparent;
        min-height: 3.5rem; display: flex; align-items: center; justify-content: center; padding: 0 10px;
      }

      .card-description {
        text-align: center; color: #ccc; font-size: 0.85rem; line-height: 1.5;
        padding: 0 15px; min-height: 3.5rem; display: -webkit-box;
        -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; margin-bottom: 15px;
      }

      /* 6. BOUTONS ET OPTIONS */
      .gold-button-premium {
        background: linear-gradient(135deg, #BF953F, #FCF6BA, #D4AF37, #FBF5B7, #BF953F);
        background-size: 200% 200%; animation: liquidGold 4s ease infinite;
        color: #000 !important; font-weight: 950; border: none; border-radius: 12px;
        padding: 15px; width: 100%; display: flex; justify-content: space-between; align-items: center;
      }

      .options-box {
        margin: auto 15px 12px; padding: 8px; background: rgba(0,0,0,0.6);
        border: 1px solid rgba(191, 149, 63, 0.2); border-radius: 12px;
      ...
      .options-box h4 {
        background: linear-gradient(135deg, #BF953F, #FCF6BA, #D4AF37, #FBF5B7, #BF953F);
        background-size: 200% 200%; animation: liquidGold 4s ease infinite;
        color: #000 !important; text-align: center; text-transform: uppercase;
        font-weight: 900; font-size: 0.8rem; padding: 5px; border-radius: 6px;
      }

      /* 7. BADGES */
      .wobble-badge-container { position: absolute; top: 10px; left: 10px; z-index: 50; }
      .wobble-badge {
        background: linear-gradient(135deg, #BF953F, #FCF6BA, #D4AF37, #FBF5B7, #BF953F) !important;
        background-size: 200% 200% !important; animation: liquidGold 4s ease infinite, wobble-badge 3s infinite ease-in-out !important;
        color: #000 !important; font-weight: 950 !important; text-transform: uppercase;
        padding: 6px 12px !important; border-radius: 50px !important; font-size: 0.7rem !important;
        display: inline-block; box-shadow: 0 4px 10px rgba(0,0,0,0.8);
      }

      /* 8. WHATSAPP */
      .whatsapp-float {
        position: fixed !important; bottom: 30px !important; right: 25px !important; z-index: 9999 !important;
        display: flex; align-items: center; justify-content: center; background-color: #25d366;
        width: 60px; height: 60px; border-radius: 50px; box-shadow: 2px 5px 15px rgba(0,0,0,0.4);
      }
      ...
      @media (max-width: 768px) {
        ...
        .card-menu-image-container { height: 200px !important; min-height: 200px !important; }
