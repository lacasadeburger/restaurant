...
// --- 2. GESTION DE LA LANGUE + CHARGEMENT INTELLIGENT MAPS ---
  ...
  return (
    ...
    <style>{`
          ...
          /* 4. IMAGES DES PRODUITS (CORRIGÉ) */
          .card-menu-image-container {
            width: 100%;
            height: 230px;
            background: #0a0a0a; /* Fond neutre si l'image charge mal */
            position: relative;
            overflow: hidden;
          ...
          /* Suppression du !important sur object-fit pour laisser le composant choisir */
          .card-menu-image-container img {
            display: block;
            width: 100%;
            height: 100%;
            object-fit: cover; /* Par défaut pour les burgers */
            opacity: 1;
            visibility: visible;
            transition: transform 0.3s ease;
          }

          /* Classes spécifiques pour Boissons et Desserts */
          .card-menu-image-container img.img-drink,
          .card-menu-image-container img.img-postre {
            object-fit: contain !important;
            padding: 10px; /* Évite que la bouteille touche les bords */
            width: 100%;
            height: 100%;
          }
