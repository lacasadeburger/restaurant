...
// --- GALERIE VISUELLE TEMPORAIRE HAUTE QUALITÉ ---
const galleryImages = [
...
export default function App() {
  ...
  // Alternance de langue automatique pour le bandeau d'accueil
  useEffect(() => {
  ...
  return (
    <div className="app-main-wrapper" style={{ position: 'relative', backgroundColor: '#111', color: '#fff' }}>
      ...
      <header style={{
        ...
        <div className="fade-text" style={{ minHeight: '140px' }}>
          {lang === 'es' ? (
            <>
            ...
            <>
              ...
              <p style={{ fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto', color: '#ccc' }}>
                The best smash burgers near <strong>Paseo Marítimo</strong>. Handcrafted with passion, delivered to you.
              </p>
            </>
          )}
        </div>
        ...
        <div style={{
          ...
          {galleryImages.map((img, idx) => (
            <div key={idx} style={{ borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 20px rgba(0,0,0,0.5)' }}>
              <img src={img} alt="Gourmet Burger" style={{ width: '100%', height: '250px', objectFit: 'cover', transition: '0.3s' }}
      ...
      {/* MENU CARDS */}
      <main className="menu-page-container" style={{ padding: '0 20px' }}>
        <section>
        ...
        {/* PANIER / COMMANDE */}
        <section id="order">
          <SectionTitle>Tu Pedido / Panier</SectionTitle>
      ...
      <a
        ...
        style={{
          ...
          alignItems: 'center', fontSize: '2rem', boxShadow: '0 4px 15px rgba(0,0,0,0.4)',
